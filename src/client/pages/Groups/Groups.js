    ...
    <div>
      <PageTitle>
        ...
        <IconButton onClick={handleClickOpen}>
          <Icon color="primary" className={classes.addIcon}>
            add
          </Icon>
        </IconButton>
      </PageTitle>
      ...
      <div className={classes.cardsContainer}>
        {chosenGroup && (
          <GroupInstances className={classes.quotesCard} group={chosenGroup} />
        )}
        <GroupsCard
          className={classes.groupsCard}
          groups={groups}
          chosen={chosenGroup && chosenGroup.name}
          clickGroup={selectGroup}
